...
const smsFilename = "generator/sms.data"

const mmsApiUrl = "http://localhost:8383/mms" // to params
const voiceFilename = "generator/voice.data"
const emailFilename = "generator/email.data"
const billingFilename = "generator/billing.data"

const supportApiUrl = "http://localhost:8383/support"
const accendentListUrl = "http://localhost:8383/accendent"
